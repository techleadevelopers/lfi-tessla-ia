...
:: Exibir Detecção de WAFs e Vazamentos
echo  │ 🚧 WAF Detectado: Cloudflare - Evadindo...
echo  │ 💥 Vazamento detectado em: http://www.rooseveltskate.com.br/download.php?file=...
